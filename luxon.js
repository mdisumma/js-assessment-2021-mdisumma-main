   ...
   */
	...
	var Formatter = /*#__PURE__*/ (function () {
		...
		_proto.formatWithSystemDefault = function formatWithSystemDefault(
			...
			var df = this.systemLoc.dtFormatter(
				dt,
	...
	var extractISOOrdinalDataAndTime = combineExtractors(
	...
	var Duration = /*#__PURE__*/ (function () {
		...
		_proto.shiftTo = function shiftTo() {
			...
			for (
				var _iterator2 = _createForOfIteratorHelperLoose(orderedUnits), _step2;
		...
		_proto.equals = function equals(other) {
			...
			for (
				var _iterator3 = _createForOfIteratorHelperLoose(orderedUnits), _step3;
	...
	var Info = /*#__PURE__*/ (function () {
		...
		Info.weekdaysFormat = function weekdaysFormat(length, _temp4) {
			...
			return Locale.create(locale, numberingSystem, null).weekdays(
				length,
				true
			);
		};
